...
<div class="mx-auto w-full max-w-[960px] px-8 pt-8 pb-16">
	...
	<div class="mb-8 grid grid-cols-4 gap-3">
		<div class="card-elevated rounded-lg border border-border-subtle bg-bg-card px-4 py-4 text-center fade-in-up" style="animation-delay: 0.05s">
			<span class="font-mono text-2xl font-bold text-accent-green glow-green">3.16e-14</span>
			<span class="mt-1 block text-[10px] font-semibold uppercase tracking-wider text-text-tertiary">Final MSE</span>
		</div>
		<div class="card-elevated rounded-lg border border-border-subtle bg-bg-card px-4 py-4 text-center fade-in-up" style="animation-delay: 0.1s">
			<span class="font-mono text-2xl font-bold text-text-primary">(48!)&#178;</span>
			<span class="mt-0.5 block font-mono text-[11px] text-text-tertiary">&#8776; 10&#185;&#178;&#185;</span>
			<span class="mt-1 block text-[10px] font-semibold uppercase tracking-wider text-text-tertiary">Search Space</span>
		</div>
		<div class="card-elevated rounded-lg border border-border-subtle bg-bg-card px-4 py-4 text-center fade-in-up" style="animation-delay: 0.15s">
			<span class="font-mono text-2xl font-bold text-accent-green glow-green">23x</span>
		...
		<div class="card-elevated rounded-lg border border-border-subtle bg-bg-card px-4 py-4 text-center fade-in-up" style="animation-delay: 0.2s">
			<span class="font-mono text-2xl font-bold text-accent-blue glow-blue">77/97</span>
	...
	<div class="mb-8 rounded-xl border border-border-subtle bg-bg-card px-6 py-5 card-elevated fade-in-up" style="animation-delay: 0.3s">
		...
		<code class="block rounded bg-bg-inset px-4 py-3 font-mono text-[13px] leading-relaxed">
	...
	<div class="mb-6 grid grid-cols-2 gap-4">
		<div class="rounded-xl border border-phase-pairing/20 bg-bg-card px-5 py-5 card-elevated fade-in-up" style="animation-delay: 0.35s">
			...
			<p class="mb-3 text-[10px] font-semibold uppercase tracking-wider text-phase-pairing">All 5 methods &#8594; 48/48</p>
			<p class="mb-3 text-[13px] leading-relaxed text-text-secondary">
				...
				<code class="rounded bg-bg-inset px-1.5 py-px font-mono text-xs text-accent-cyan">|tr(W_out &#183; W_inp)|</code>
		...
		<div class="rounded-xl border border-phase-ordering/20 bg-bg-card px-5 py-5 card-elevated fade-in-up" style="animation-delay: 0.4s">
			...
			<p class="mb-3 text-[10px] font-semibold uppercase tracking-wider text-phase-ordering">All methods &#8594; exact after polish</p>
			<p class="mb-3 text-[13px] leading-relaxed text-text-secondary">
	...
	<div class="mb-6 rounded-xl border border-phase-interpret/20 bg-bg-card px-5 py-5 card-elevated fade-in-up" style="animation-delay: 0.45s">
		...
		<div class="grid grid-cols-3 gap-4 text-[13px] leading-relaxed text-text-secondary">
			<div>
				<span class="mb-1 block text-[11px] font-semibold uppercase tracking-wider text-phase-ordering">Low-Rank Factor Track</span>
				96% of trajectory variance in first 3 PCs. The 48-block trajectory through 48-D space is effectively 3-dimensional.
			</div>
			<div>
				<span class="mb-1 block text-[11px] font-semibold uppercase tracking-wider text-phase-e2e">Selective Amplification</span>
				Top-PC shocks amplified (1.88x), bottom-PC shocks damped (0.69x). Prediction sensitivity gap: 22x.
			</div>
			<div>
				<span class="mb-1 block text-[11px] font-semibold uppercase tracking-wider text-phase-interpret">Three Phases</span>
